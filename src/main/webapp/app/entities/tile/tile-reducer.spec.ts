...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './tile.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TILE_LIST actions', async () => {
    ...
    it('dispatches FETCH_TILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TILE actions', async () => {
      const expectedActions = [
        {
