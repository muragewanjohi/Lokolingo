...
describe('Tile routing resolve service', () => {
  ...
  let resultTile: ITile | null | undefined;
  ...
  describe('resolve', () => {
    it('should return ITile returned by find', () => {
      ...
      expect(resultTile).toEqual({ id: 123 });
    });
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultTile).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ITile>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
