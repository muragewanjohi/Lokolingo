...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './learning.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEARNING_LIST actions', async () => {
    ...
    it('dispatches FETCH_LEARNING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LEARNING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LEARNING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LEARNING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LEARNING actions', async () => {
      const expectedActions = [
        {
