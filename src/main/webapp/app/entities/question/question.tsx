              ...
              {questionList.map((question, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {question.audio ? (
                      <div>
                        {question.audioContentType ? (
                          <a onClick={openFile(question.audioContentType, question.audio)}>Open &nbsp;</a>
                        ) : null}
                        <span>
                          {question.audioContentType}, {byteSize(question.audio)}
                        </span>
                      </div>
                    ) : null}
                  </td>
                  <td>{question.audioDescription}</td>
