...
type QuestionFormGroupContent = {
  ...
  audio: FormControl<IQuestion['audio']>;
  audioContentType: FormControl<IQuestion['audioContentType']>;
  audioDescription: FormControl<IQuestion['audioDescription']>;
};
...
export class QuestionFormService {
  createQuestionFormGroup(question: QuestionFormGroupInput = { id: null }): QuestionFormGroup {
    ...
    return new FormGroup<QuestionFormGroupContent>({
      ...
      audio: new FormControl(questionRawValue.audio, {
        validators: [Validators.required],
      }),
      audioContentType: new FormControl(questionRawValue.audioContentType),
      audioDescription: new FormControl(questionRawValue.audioDescription, {
        validators: [Validators.required],
      }),
    });
  }
