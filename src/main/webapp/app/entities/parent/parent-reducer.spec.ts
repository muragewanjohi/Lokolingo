...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './parent.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PARENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_PARENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PARENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PARENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PARENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PARENT actions', async () => {
      const expectedActions = [
        {
