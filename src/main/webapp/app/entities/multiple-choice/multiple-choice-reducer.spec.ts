...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MULTIPLECHOICE_LIST actions', async () => {
    ...
    it('dispatches FETCH_MULTIPLECHOICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MULTIPLECHOICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MULTIPLECHOICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MULTIPLECHOICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MULTIPLECHOICE actions', async () => {
      const expectedActions = [
        {
