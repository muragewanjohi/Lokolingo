...
export const Subject = () => {
  ...
  const totalItems = useAppSelector(state => state.subject.totalItems);
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  Learning <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {subjectList.map((subject, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{subject.title}</td>
                  <td>{subject.learning ? <Link to={`/learning/${subject.learning.id}`}>{subject.learning.id}</Link> : ''}</td>
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`/subject/${subject.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      ...
                      <Button
                        tag={Link}
                        to={`/subject/${subject.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
