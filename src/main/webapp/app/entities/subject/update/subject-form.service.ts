...
type SubjectFormGroupContent = {
  ...
  age: FormControl<ISubject['age']>;
  language: FormControl<ISubject['language']>;
  title: FormControl<ISubject['title']>;
};
...
export class SubjectFormService {
  createSubjectFormGroup(subject: SubjectFormGroupInput = { id: null }): SubjectFormGroup {
    ...
    return new FormGroup<SubjectFormGroupContent>({
      ...
      age: new FormControl(subjectRawValue.age),
      language: new FormControl(subjectRawValue.language, {
        validators: [Validators.required],
      }),
      title: new FormControl(subjectRawValue.title, {
        validators: [Validators.required],
      }),
    });
  }
