...
public class QuestionServiceImpl implements QuestionService {
    ...
    /**
     *  Get all the questions where Tile is {@code null}.
     *  @return the list of entities.
     */
    @Transactional(readOnly = true)
    public List<Question> findAllWhereTileIsNull() {
        log.debug("Request to get all questions where Tile is null");
        return StreamSupport
            .stream(questionRepository.findAll().spliterator(), false)
            .filter(question -> question.getTile() == null)
