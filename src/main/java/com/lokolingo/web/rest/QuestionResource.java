...
/**
 * REST controller for managing {@link com.lokolingo.domain.Question}.
 */
@RestController
@RequestMapping("/api")
public class QuestionResource {
    ...
    public List<Question> getAllQuestions(@RequestParam(required = false) String filter) {
        if ("tile-is-null".equals(filter)) {
            log.debug("REST request to get all Questions where tile is null");
            return questionService.findAllWhereTileIsNull();
        }
