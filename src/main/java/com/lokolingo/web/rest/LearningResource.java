...
public class LearningResource {
    ...
    public List<Learning> getAllLearnings(@RequestParam(required = false) String filter) {
        if ("child-is-null".equals(filter)) {
            log.debug("REST request to get all Learnings where child is null");
            return learningService.findAllWhereChildIsNull();
        }
