...
class QuestionResourceIT {
    ...
    private static final String DEFAULT_AUDIO_DESCRIPTION = "AAAAAAAAAA";
    private static final String UPDATED_AUDIO_DESCRIPTION = "BBBBBBBBBB";
    ...
    public static Question createEntity(EntityManager em) {
        Question question = new Question()
            ...
            .audioDescription(DEFAULT_AUDIO_DESCRIPTION);
        return question;
    }
    ...
    public static Question createUpdatedEntity(EntityManager em) {
        Question question = new Question()
            ...
            .audioDescription(UPDATED_AUDIO_DESCRIPTION);
        return question;
    }
    ...
    void createQuestion() throws Exception {
        ...
        assertThat(testQuestion.getAudio()).isEqualTo(DEFAULT_AUDIO);
        assertThat(testQuestion.getAudioContentType()).isEqualTo(DEFAULT_AUDIO_CONTENT_TYPE);
        assertThat(testQuestion.getAudioDescription()).isEqualTo(DEFAULT_AUDIO_DESCRIPTION);
    }
    ...
    @Test
    @Transactional
    void checkAudioDescriptionIsRequired() throws Exception {
        int databaseSizeBeforeTest = questionRepository.findAll().size();
        // set the field null
        question.setAudioDescription(null);
    ...
    void getAllQuestions() throws Exception {
        ...
        restQuestionMockMvc
            ...
            .andExpect(jsonPath("$.[*].audioDescription").value(hasItem(DEFAULT_AUDIO_DESCRIPTION)));
    }
    ...
    void getQuestion() throws Exception {
        ...
        restQuestionMockMvc
            ...
            .andExpect(jsonPath("$.audioDescription").value(DEFAULT_AUDIO_DESCRIPTION));
    }
    ...
    void putExistingQuestion() throws Exception {
        ...
        assertThat(testQuestion.getAudio()).isEqualTo(UPDATED_AUDIO);
        assertThat(testQuestion.getAudioContentType()).isEqualTo(UPDATED_AUDIO_CONTENT_TYPE);
        assertThat(testQuestion.getAudioDescription()).isEqualTo(UPDATED_AUDIO_DESCRIPTION);
    }
